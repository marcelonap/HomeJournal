class ErrandsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to errands_path, status: :see_other, notice: "Errand was successfully destroyed." }
  ...
  private
    ...
    def set_errand
      @errand = Errand.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def errand_params
      params.expect(errand: [ :category, :location ])
    end
end
